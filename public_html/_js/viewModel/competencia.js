    ...
    self.loadPage = function () {
        if (!document.getElementById("contentCompetencia")) {
            $("#content").load("_js/view/competencia.html", function () {
                ...
                self.competencias(["Front-end", "HTML5", "MySQL", ".NET", "SQL Server", "CSS3", "Knockout", "AngularJs", "Frameworks JS", "Jasmine", "Jenkins", "Testes Unitarios", "C#", "Phonegap",".Net", "Java", "Jenkins", "GitHub", "Python", "Mobile", "MVC", "PHP", "Wordpress","Java Swing", "Cordova"]);
            });
        }
    };
};
