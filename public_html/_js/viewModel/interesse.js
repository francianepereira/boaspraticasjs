    ...
    self.loadPage = function () {
        if (!document.getElementById("contentInteresse")) {
            $("#content").load("_js/view/interesse.html", function () {
                ...
                self.interesses([ "Android", "Análise de sistema", "Front-End", "Mobile", "IOS", "Databases", ".NET", "Sql Server", "Frameworks JS", "Testes Unitarios", "GitHub", "Java", "Jenkins", "GitHub", "Python", "Git", "Mobile", "MVC", "PHP", "Linux", "ReactJs"]);
